...
export default function ClientsPage() {
  ...
  return (
    <div style={{ padding: "24px" }}>
      <h1 style={{ color: "#1F3864", marginBottom: "12px" }}>Clients</h1>
      <p style={{ color: "#666", marginTop: "10px", marginBottom: "24px" }}>Client funnel management - Heyleen Alejandra Lopez</p>
