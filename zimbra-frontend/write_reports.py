...
export default function ReportsPage() {
  ...
  return (
    <div style={{ padding: "24px" }}>
      <h1 style={{ color: "#1F3864", marginBottom: "4px" }}>Performance Reports</h1>
      <p style={{ color: "#666", marginBottom: "24px" }}>Marketing and sales metrics by period - Heyleen Alejandra Lopez</p>
        ...
        <div key={i} style={{ background: "#fff", border: "1px solid #ddd", borderRadius: "8px", padding: "20px", marginBottom: "16px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "12px" }}>
            <div style={{ background: "#E2EFDA", borderRadius: "8px", padding: "16px", textAlign: "center" }}>
              ...
              <p style={{ margin: "4px 0 0", fontSize: "22px", fontWeight: "bold", color: "#1E8449" }}></p>
            </div>
