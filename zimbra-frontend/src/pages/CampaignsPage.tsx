...
export default function CampaignsPage() {
  ...
  return (
    <div style={{ padding: "24px" }}>
      <h1 style={{ color: "#1F3864", marginBottom: "12px" }}>Campaigns</h1>
      <p style={{ color: "#666", marginTop: "10px", marginBottom: "24px" }}>Marketing campaigns management - Heyleen Alejandra Lopez</p>
